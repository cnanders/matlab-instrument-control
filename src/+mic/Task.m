classdef Task < mic.interface.Task
    ...
    methods (Static)
        ...
        function task = fromUiGetSetNumber(ui, dGoal, dTolerance, cUnit, cName)
            ...
            fhExecute = @() mic.Utils.evalAll(...
                @() ui.setDestCal(dGoal, cUnit), ... % setDestCal (2019.11.04)
                @() ui.moveToDest() ...
            );
        ...
        % in the auto-generated message.  Message will look like: 
        % 'Set {cName} to {dVal}'
        function task = fromUiGetSetNumberWithGoalGetter(...
                ui, ...
                fhGetGoal, ...
                dTolerance, ...
                cUnit, ...
            ...
            task = mic.Task(...
                ...
                'fhAbort', @() ui.stop(), ...
                'fhIsExecuting', @() ~ui.getDevice().isReady(), ...
                'fhIsDone', @() abs(ui.getValCal(cUnit) - fhGetGoal()) <= dTolerance, ...
                'fhGetMessage', fhGetMessage ... 
            );
