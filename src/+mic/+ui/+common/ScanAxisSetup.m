classdef ScanAxisSetup < mic.Base
    ...
    properties (Access = protected)
        ...
        fhDirectCallback = @()disp('Scan parameter changed') % Called when any scan parameters change
...
%         
            ...
            this.uieStart = mic.ui.common.Edit(...
                ...
                'cType', 'd', ...
                'lShowLabel', true, ...
                'fhDirectCallback', this.fhDirectCallback ...
                );
        ...
        function lVal = useDelta(this)
            lVal = this.uicbCenterOnValue.get();
        end
