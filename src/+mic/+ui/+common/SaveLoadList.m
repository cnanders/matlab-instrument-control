    ...
    methods
        ...
        function this = SaveLoadList(varargin)
            ...
            this.uibSave = mic.ui.common.Button(...
                'cText', 'Save position', 'hDirectCallback', @this.savePosition ...
            );
            this.uibLoad = mic.ui.common.Button(...
                'cText', 'Load position', 'hDirectCallback', @this.loadPosition ...
            );
        
            this.uibSync = mic.ui.common.Button(...
                'cText', 'Sync', 'hDirectCallback', @this.syncPositionLists ...
            );
