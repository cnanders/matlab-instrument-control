...
%thatm use PopupStruct instead of UIPopup
    ...
    properties (Access = private)
        ...
        % allows drawing the label and select as two columns side-by-side
        lTwoCol = false
        dWidthLabel = 180
        dWidthSelect = 100
        dWidthPadLabel = 5
    ...
    methods
       ...
       function build(this, hParent, dLeft, dTop, dWidth, dHeight)
           ...
           if this.lTwoCol
               ...
               dHeight = 20;
               dLeft = dLeft + this.dWidthPadLabel;
               
               this.hLabel = uicontrol( ...
                    'Parent', hParent, ...
                    'Position', mic.Utils.lt2lb([dLeft dTop this.dWidthLabel 20], hParent),...
                    'Style', 'text', ...
                    'String', this.cLabel, ...
                    'FontWeight', 'Normal',...
                ...
                dLeft = dLeft + this.dWidthLabel + this.dWidthPadSelect;
